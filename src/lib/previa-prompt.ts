...
export function generatePrompt(
	...
	if (isTextOnly) {
		...
		lines.push('┌─────────────────────────────────────────────────────────┐');
		lines.push('│ [1] imagebase     = Composition reference template      │');
		lines.push('│                     (framing, angle, lighting setup)    │');
		lines.push('│                     🚨 CONTROLS OUTPUT DIMENSIONS        │');
		lines.push('│                                                         │');
		lines.push('│ [2] imageproduct  = Main product photo                  │');
		...
		lines.push('│                     (PRESERVE all colors/lighting)      │');
		lines.push('│                                                         │');
		lines.push('│ [3] imagelogo     = Logo to engrave                     │');
	...
	lines.push('┌─────────────────────────────────────────────────────────┐');
	lines.push('│ OUTPUT IMAGE DIMENSIONS MUST MATCH IMAGEBASE EXACTLY:   │');
	lines.push('│                                                         │');
	lines.push('│ • Width:  SAME as imagebase width (pixels)              │');
	lines.push('│ • Height: SAME as imagebase height (pixels)             │');
	lines.push('│ • Aspect Ratio: IDENTICAL to imagebase                  │');
	lines.push('│ • Resolution: MATCH imagebase resolution                │');
	lines.push('│                                                         │');
	lines.push('│ ⚠️ DO NOT change dimensions, crop, resize, or scale     │');
	lines.push('│    the output - it MUST be pixel-perfect match          │');
	lines.push('│                                                         │');
	lines.push('│ Example:                                                │');
	lines.push('│ • If imagebase = 1920x1080px                            │');
	lines.push('│ • Then output  = 1920x1080px (EXACT MATCH)              │');
	lines.push('└─────────────────────────────────────────────────────────┘');
	lines.push('');
	lines.push('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━');
	...
	lines.push('│    • Match imagebase framing exactly                    │');
	lines.push('│    • CRITICAL: Output dimensions = imagebase dimensions │');
	lines.push('│    • Width x Height MUST be identical (pixel-perfect)   │');
	lines.push('│    • Same angle, perspective, and lighting              │');
	lines.push('│    • Consistent resolution and quality                  │');
	...
	lines.push('└─────────────────────────────────────────────────────────┘');
	lines.push('');
	lines.push('🎨 IMAGEBASE DECORATIVE ELEMENTS:');
	lines.push('┌─────────────────────────────────────────────────────────┐');
	lines.push('│ ⚠️ CRITICAL - MANDATORY PRESERVATION:                   │');
	lines.push('│                                                         │');
	lines.push('│ • Keep ALL decorative elements from imagebase          │');
	lines.push("│   (example: 'M' letter in corners, brand marks)        │");
	lines.push('│                                                         │');
	lines.push('│ • Do NOT remove, modify, hide, or alter                │');
	lines.push('│   ANY decorative elements visible in imagebase         │');
	lines.push('│                                                         │');
	lines.push('│ • Preserve background elements, corner decorations,    │');
	lines.push('│   branding, and all template features                  │');
	lines.push('│                                                         │');
	lines.push('│ • These elements are part of the composition template  │');
	lines.push('│   and MUST remain in the final output unchanged        │');
	lines.push('│                                                         │');
	lines.push('│ • Copy exact positioning, size, and appearance         │');
	lines.push('│   from imagebase reference                             │');
	lines.push('└─────────────────────────────────────────────────────────┘');
	lines.push('');
	...
	const rotation = parseInt(laserSettings.rotacao, 10);
	...
	lines.push('│ [✓] Output width = imagebase width (EXACT MATCH)        │');
	lines.push('│ [✓] Output height = imagebase height (EXACT MATCH)      │');
	lines.push('│ [✓] Output aspect ratio = imagebase aspect ratio        │');
	lines.push('│ [✓] NO cropping, resizing, or scaling applied           │');
	lines.push('│                                                         │');
	lines.push('│ COMPOSITION PRESERVATION (CRITICAL):                    │');
	lines.push('│ [✓] ALL decorative elements from imagebase preserved    │');
	lines.push("│     (like 'M' in corners - DO NOT remove)               │");
	lines.push('│                                                         │');
	lines.push('│ [✓] Background elements and corner decorations intact   │');
	lines.push('│     (exactly as shown in imagebase)                     │');
	lines.push('│                                                         │');
	...
	lines.push('┌─────────────────────────────────────────────────────────┐');
	lines.push('│ • If output dimensions differ from imagebase:           │');
	lines.push('│   → Output is INVALID - regenerate with exact size      │');
	lines.push('│   → Width and height MUST match imagebase exactly       │');
	lines.push('│                                                         │');
	lines.push('│ • If ANY colored pixels detected in engraving:          │');
	lines.push('│   → Output is INCORRECT - regenerate completely         │');
	lines.push('│                                                         │');
	lines.push('│ • If decorative elements from imagebase are missing:    │');
	lines.push('│   → Output is INCOMPLETE - add missing elements         │');
	lines.push('│                                                         │');
